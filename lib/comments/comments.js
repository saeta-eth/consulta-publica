...
export default class CommentsView extends FormView {
  ...
  selectCategoryInput (e) {
    ...
    console.log(this.find('.form-group:not(.categories-input)')[0].style.opacity);
  ...
  commentFormCategories () {
    this.find('.categories-input')[0].style.opacity = 1;
    this.find('.new-comment')[0].style.opacity = 0;
    this.find('.new-comment')[0].style.zIndex = 0;
